...
def build_config() -> dict[str, str]:
    ...
    return dict(
        ...
        # Misc meson settings
        meson_backend="ninja",
        build_dir=r"/tmp/pip-wheel-8yzmv97z/contourpy_c4bfee03032f4f2f9f687a0e9c4c7312/.mesonpy-alz82x0k/lib/contourpy/util",
        source_dir=r"/tmp/pip-wheel-8yzmv97z/contourpy_c4bfee03032f4f2f9f687a0e9c4c7312/lib/contourpy/util",
        cross_build="False",

        # Build options
        build_options=r"-Dbuildtype=release -Db_ndebug=if-release -Db_vscrt=md -Dvsenv=True --native-file=/tmp/pip-wheel-8yzmv97z/contourpy_c4bfee03032f4f2f9f687a0e9c4c7312/.mesonpy-alz82x0k/meson-python-native-file.ini",
        buildtype="release",
        cpp_std="c++17",
        debug="False",
        optimization="3",
